...
ConnectDialog::ConnectDialog(
    wxWindow* parent, wxWindowID id, const wxString& title) : wxDialog(parent, id, title)
{
	wxFlexGridSizer* flexSizer = new wxFlexGridSizer(2);

	flexSizer->Add(new wxStaticText(this, wxID_ANY, wxT("&Host:")), 0, wxALL | wxALIGN_RIGHT, 5);
	m_ctlAddressTxt = new wxTextCtrl(this, wxID_ANY, wxT("192.168.1.143"));
	flexSizer->Add(m_ctlAddressTxt, 0, wxALL, 5);

	flexSizer->Add(new wxStaticText(this, wxID_ANY, wxT("&Port:")), 0, wxALL | wxALIGN_RIGHT, 5);
